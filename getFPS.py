...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp1//weights/best.pt', help='trained weights path')
    ...
    parser.add_argument('--warmup', default=300, type=int, help='warmup time')
